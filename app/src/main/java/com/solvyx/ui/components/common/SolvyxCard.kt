 ...
 *
 * Centraliza el look en un solo lugar (esquinas 20dp, fondo `surfaceDim`, elevación 1dp y borde
 * `outline` al 25%) para que todas las vistas se vean iguales y un cambio de estilo se haga una vez.
 *
